    ...
    return (<table class="my-3 table-auto border-collapse border border-blue-700">
        <thead>
            <tr className="bg-blue-200">
                <th className="border py-2 text-blue-500 border-blue-700">Ejercicios</th>
        ...
        <tbody>
            <tr>
                <td className="tracking-wide border font-medium text-base text-white border-blue-700 py-1 px-2 ">DO <span className="text-black">FA </span>  DO <span className="text-black">DO </span> FA <span className="text-black">DO </span> FA</td>
                {/*                 <td className="border text-blue-100 border-blue-700 py-1 px-2"><PlayButton /></td>
 */}
            </tr>
            <tr className="bg-blue-200">
                <td className=" tracking-wide border font-medium text-base text-blue-600 border-blue-700 py-1 px-2">
                    MI <span className="text-black">SI </span> FA <span className="text-black">DO </span> FA <span className="text-black">SI </span> FA <span className="text-black">DO </span>
                </td>
                {/*                 <td className="border text-blue-500 border-blue-700 py-1 px-2"><PlayButton /></td>
 */}
            </tr>
            <tr>
                <td className="tracking-wide border font-medium text-base text-white border-blue-700 py-1 px-2">
